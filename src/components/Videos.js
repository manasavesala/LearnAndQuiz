    ...
    return (
        <div>
            ...
            <div className="uk-cover-container uk-height-medium ">
                <br />
                <iframe src="https://www.youtube.com/watch?v=6Wzj7kxfRdI-4?autoplay=1&amp;controls=0&amp;showinfo=0&amp;rel=0&amp;loop=1&amp;modestbranding=1&amp;wmode=transparent" width="560" height="315"></iframe>
            </div>
